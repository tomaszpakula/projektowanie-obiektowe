...
class __TwigTemplate_fdf6bd6af2eded616e9371df2de1fb92b15ab2ecec06b561c9800c137aa1753b extends Template
{
    private $source;
    private $macros = [];
...
<body>
    ...
    <p><strong>Name:</strong> ";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 9, $this->source); })()), "name", [], "any", false, false, false, 9), "html", null, true);
        yield "</p>

    <a href=\"";
        // line 11
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category_list");
        yield "\">Back to Categories List</a>
</body>
</html>";
    ...
    {
        return array (  62 => 11,  57 => 9,  53 => 8,  44 => 1,);
    }
...
<body>
    ...
    <a href=\"{{ path('category_list') }}\">Back to Categories List</a>
</body>
</html>", "category/show.html.twig", "/home/tomasz/projektowanie-obiektowe/zadanie2/templates/category/show.html.twig");
    }
}
